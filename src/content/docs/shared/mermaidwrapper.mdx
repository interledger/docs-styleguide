...
:::caution
This component requires an extra dependency on [remark-mermaidjs](https://github.com/remcohaszing/remark-mermaidjs) and thus is not enabled by default on all projects. Please ping the person responsible for documentation architecture if your project doesn't render mermaid markdown properly.
:::
