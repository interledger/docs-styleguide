...
<table>
   <tr style="background-color:white;">
     ...
     <td><p>A vertical line descending from the center-bottom of an actor or participant and represents the existence of the actor/participant over time.</p><p>Used as a boundary to show the sequential events that occur to the actor/participant.</p></td>
   </tr>
</table>
</details>
