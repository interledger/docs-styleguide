...
:::note
As of November 29, 2023, this button will not appear when using the in-house [ChunkedSnippet](/oppm/chunkedsnippet) component.
:::

### Syntax highlighting

You can indicate the programming language to use if you want to use syntax highlighting. Astro uses the [Shiki highlighter](https://github.com/shikijs/shiki/blob/main/docs/languages.md#all-languages), so check their documentation if you aren't sure if your language is supported.
...
```tex title="Starlight default title style"
...
:::danger
We no longer support mermaid diagrams using the markdown syntax. Instead, please use the [`Mermaid` component](/shared/mermaid).
:::
